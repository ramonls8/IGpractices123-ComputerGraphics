...
Escena2::Escena2()
{
   ...
   objetos.push_back( new P2Barrido(10, 10) );
   ...
   objetos.push_back( new MallaRevolPLY("lata-pcue", 50) );
   objetos.push_back( new MallaRevolPLY("lata-pinf", 50) );
   objetos.push_back( new MallaRevolPLY("lata-psup", 50) );
   objetos.push_back( new MallaRevolPLY("peon", 50) );
...
Escena3::Escena3()
{
   ...
   objetos.push_back( new Klinklang() );
